...
%     Iner_var(k,1) = sqrt(COV(3,3));
    ...
    [Params_int,Ps_int,est] = my_rivbjmiso(double(tqI),[decimate(input_position(101:N+100),10) decimate(velocity(101:N+100),10) decimate(acceleration(101:N+100),10)],0,ones(1,3));
