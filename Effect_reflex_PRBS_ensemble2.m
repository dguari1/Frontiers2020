...
for p =1:4
    ...
    figure;
    subplot(1,3,1)
    plot(mean(RtoI'), K*ones(length(mean(RtoI')),1),'Color','red') 
    hold on
    ...
    subplot(1,3,2)
    plot(mean(RtoI'), B*ones(length(mean(RtoI')),1),'Color','red') 
    hold on
    ...
    subplot(1,3,3)
    plot(mean(RtoI'), I*ones(length(mean(RtoI')),1),'Color','red') 
    hold on
